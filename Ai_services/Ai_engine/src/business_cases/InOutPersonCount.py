...
from src.Exception.Exception import PredictionError, FrameProcessingException, InOutPersonCountException
    ...
    def detect(self, frame: np.ndarray, lines: List[List[Tuple[int, int]]], detector: Any) -> Tuple[bool, np.ndarray, Dict[str, Any]]:
        ...
        try:
            ...
            try:
                ...
                self.logger.error(f"Error during object tracking in InOutPersonCount: {e}")
            ...
            try:
                ...
                self.logger.error(f"Error processing detections in InOutPersonCount: {e}")
            ...
            raise InOutPersonCountException(str(e))
        except Exception as e:
            self.logger.error(f"Unexpected error in InOutPersonCount: {e}")
            raise InOutPersonCountException(f"InOutPersonCount failed: {e}")
