...
class Constants:
    ...
    TRAIN_ARRIVAL_DEPART_MONITOR = "TRAIN_ARRIVAL_DEPART_MONITOR"
...
#ADD ------------------
    AI_INFERENCE_CLASSIFICATION_MODEL_PATH = "AI_INFERENCE_CLASSIFICATION_MODEL_PATH"
    AI_INFERENCE_CLASSIFICATION_QUEUE = "AI_INFERENCE_CLASSIFICATION_QUEUE"
    ...
    CROWD_DENSITY_CONFIDENCE = "CROWD_DENSITY_CONFIDENCE"  
    ...
    PERSON_COUNT_INSIDE_COMPARTMENT_CONFIDENCE = "PERSON_COUNT_INSIDE_COMPARTMENT_CONFIDENCE"  #add
    ...
    COMPONENTS_MAPPING = {
        ...
        "queue_train_arrival_depart_monitor":"train_arrival_depart_monitor",
    ...
    TRAIN_ARRIVAL_DEPART_MONITOR_QUEUE = "queue_train_arrival_depart_monitor",
    CROWD_DENSITY_QUEUE = "queue_crowd_density"
    ...
    USECASE_QUEUE_MAPPING = {
        ...
        TRAIN_ARRIVAL_DEPART_MONITOR_QUEUE:TRAIN_ARRIVAL_DEPART_MONITOR_USECASE,
