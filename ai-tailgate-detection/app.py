...
# Use Tailgate Queue
VisionPipeline.queue_name = os.environ.get(Constants.QUEUE_NAME, Constants.TAILGATE_DETECTION_QUEUE)
...
def initialize_detectors() -> None:
    ...
    try:
        ...
        model_path: str = os.environ.get(
            Constants.TAILGATE_DETECTION_MODEL_PATH,
            cfg.get_value_config(Constants.TAILGATE_DETECTION, Constants.TAILGATE_DETECTION_MODEL_PATH)
        )
